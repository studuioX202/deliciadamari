...
document.querySelector('#submit').addEventListener('click',function(){
  ...
  let coverquatidade = Math.round( parseInt(quantidade))
 ...
 let url = "https://api.whatsapp.com/send?phone=5585981073174&text= *Nome do Cliente:*%0A " + cliente +"%0A*Codido do seu pedido é:*%0A"+ codProduto +"%0A*Quantidade:*%0A" + coverquatidade +"%0A*Nome do Produto:*%0A"+ nomePedido+ "%0A*Forma de pagamento:*%0A" + pagamento+"%0A*Valor da Unidade:*%0A"+obs+"%0A*Entregar em:*%0A"+endereco+"%0A*total do pedido:*%0A"+total; 
